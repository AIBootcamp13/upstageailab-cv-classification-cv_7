...
|                            팀장</br> 모델 학습 및 실험</br> Sweep 도입                             |                            팀원 </br>Wandb, hydra 환경구축 </br>모델 학습 파이프라이닝 </br>모델실험                             |                            팀원</br>모델 학습 실습                             |                            팀원</br>모델 학습 실습                             |                            팀원 </br>노션 관리 및 회의록 작성</br>모델 학습 및 실험                             |

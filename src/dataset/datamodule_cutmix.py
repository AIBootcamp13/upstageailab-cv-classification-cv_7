...
from src.dataset.cutmixdataset import PureCutMixDataset
...
class DocumentDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        if stage == "fit" or stage is None:
            ...
            self.cutmix_dataset = PureCutMixDataset(self.train_dataset, alpha=1.0)
    ...
    def train_dataloader(self):
        ...
        return CombinedLoader({
          ...
          'cutmix': DataLoader(self.cutmix_dataset, batch_size=self.batch_size, shuffle=True, num_workers=self.num_workers, persistent_workers=self.persistent_workers)
        }, mode="max_size_cycle")
